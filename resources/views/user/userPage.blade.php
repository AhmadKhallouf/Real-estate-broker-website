      ...
      <section class="flex">
         ...
         <div class="menu">
            <ul>
               ...
               <li><a href="{{ route('adminBoardRoute') }}">AdminBoardControle</a></li>
               @endif
               <li class="nav-item dropdown">
                  ...
                  <a href="{{ route('markAllNotUserARRoute') }}" class="float-right text-light">Mark all as read</a>
                  </div>
                  </li>
                  ...
                  @if ($notification->data['noteUpload'])
                  <div>
                  <a>{{ $notification->data['noteUpload'] }}</a>
                  </div>
                  @else
                  <div>
                  <a>{{ $notification->data['noteAccept'] }}</a>
                  </div> 
                  @endif
